...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.VerticalLayout","com.vaadin.ui.NativeSelect","com.vaadin.ui.CustomComponent","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.AbsoluteLayout","com.vaadin.server.FileDownloader","com.vaadin.ui.PopupView","com.vaadin.ui.Upload","com.vaadin.ui.ComboBox","com.vaadin.ui.BrowserFrame","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.Accordion","com.vaadin.ui.TextField","com.vaadin.ui.Button","com.vaadin.ui.DateField","com.vaadin.ui.OptionGroup","com.vaadin.ui.TreeTable","com.vaadin.ui.Flash","com.vaadin.ui.Audio","com.vaadin.ui.CssLayout","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.Image","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.FormLayout","com.vaadin.ui.Panel","com.vaadin.ui.GridLayout","com.vaadin.ui.JavaScript","com.vaadin.ui.CustomLayout","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.CheckBox","com.vaadin.ui.Window","com.vaadin.ui.Link","com.vaadin.ui.Form","com.vaadin.ui.TabSheet","com.vaadin.ui.Slider","com.vaadin.ui.Table","com.vaadin.ui.NativeButton","com.vaadin.ui.InlineDateField","com.vaadin.ui.Label","com.vaadin.ui.TwinColSelect","com.vaadin.ui.ListSelect","com.vaadin.ui.PasswordField","com.vaadin.ui.CustomField","com.vaadin.ui.Video","com.vaadin.ui.TextArea","com.vaadin.ui.Embedded","com.vaadin.ui.MenuBar","com.vaadin.ui.Tree","com.vaadin.ui.UI",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"enabled", "immediate", "id", "clickShortcutKeyCode", "height", "resources", "primaryStyleName", "disableOnClick", "registeredEventListeners", "caption", "readOnly", "errorMessage", "width", "htmlContentAllowed", "styles", "description", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"resources", "primaryStyleName", "styles", "hideErrors", "caption", "readOnly", "propertyReadOnly", "immediate", "tabIndex", "height", "footer", "description", "registeredEventListeners", "required", "width", "errorMessage", "id", "layout", "modified", "enabled", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"id", "resources", "width", "description", "styles", "enabled", "contentMode", "readOnly", "text", "height", "registeredEventListeners", "immediate", "errorMessage", "caption", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"hideErrors", "width", "pollingInterval", "styles", "enabled", "indeterminate", "propertyReadOnly", "readOnly", "registeredEventListeners", "resources", "description", "tabIndex", "height", "modified", "id", "caption", "state", "errorMessage", "primaryStyleName", "immediate", "required", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"propertyReadOnly", "hideErrors", "height", "caption", "required", "id", "primaryStyleName", "value", "description", "readOnly", "resources", "minValue", "resolution", "styles", "immediate", "orientation", "errorMessage", "tabIndex", "enabled", "modified", "registeredEventListeners", "maxValue", "width", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"errorMessage", "readOnly", "primaryStyleName", "alternateText", "immediate", "styles", "description", "resources", "height", "enabled", "caption", "width", "id", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"immediate", "modified", "caption", "readOnly", "description", "primaryStyleName", "errorMessage", "hideErrors", "resources", "propertyReadOnly", "styles", "width", "enabled", "height", "id", "required", "registeredEventListeners", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"immediate", "styles", "registeredEventListeners", "height", "id", "rpcInterfaces", "enabled", "readOnly", "description", "caption", "errorMessage", "resources", "width", "callbackNames", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"caption", "resources", "styles", "immediate", "id", "enabled", "width", "scrollLeft", "readOnly", "tabIndex", "scrollTop", "registeredEventListeners", "errorMessage", "primaryStyleName", "height", "description", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"styles", "primaryStyleName", "errorMessage", "id", "width", "readOnly", "immediate", "description", "registeredEventListeners", "height", "enabled", "caption", "resources", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"row2", "row1", "column1", "column2", "alignment", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"immediate", "resources", "styles", "errorMessage", "caption", "height", "readOnly", "registeredEventListeners", "width", "id", "enabled", "primaryStyleName", "description", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"marginsBitmask", "caption", "errorMessage", "primaryStyleName", "styles", "childData", "description", "spacing", "resources", "registeredEventListeners", "enabled", "readOnly", "width", "height", "immediate", "id", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"primaryStyleName", "registeredEventListeners", "required", "id", "immediate", "resources", "height", "width", "propertyReadOnly", "errorMessage", "styles", "modified", "caption", "description", "readOnly", "hideErrors", "tabIndex", "enabled", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"caption", "readOnly", "id", "positionX", "positionY", "resources", "width", "errorMessage", "enabled", "modal", "height", "resizable", "scrollTop", "immediate", "registeredEventListeners", "centered", "scrollLeft", "styles", "description", "resizeLazy", "tabIndex", "draggable", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"altKey", "type", "button", "relativeY", "ctrlKey", "metaKey", "relativeX", "clientY", "clientX", "shiftKey", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"enabled", "secondChild", "immediate", "styles", "resources", "description", "height", "width", "errorMessage", "id", "caption", "registeredEventListeners", "firstChild", "splitterState", "readOnly", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"readOnly", "resources", "width", "id", "marginsBitmask", "height", "immediate", "styles", "primaryStyleName", "caption", "registeredEventListeners", "enabled", "description", "spacing", "errorMessage", "childData", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"styles", "errorMessage", "caption", "readOnly", "primaryStyleName", "width", "immediate", "description", "resources", "id", "height", "enabled", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.communication.SharedState.class, new String[] {"resources", "enabled", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"enabled", "rpcInterfaces", "callbackNames", "resources", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"resources", "caption", "spacing", "width", "id", "columns", "description", "height", "registeredEventListeners", "immediate", "styles", "childData", "marginsBitmask", "enabled", "errorMessage", "primaryStyleName", "rows", "readOnly", });
            ...
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"width", "description", "immediate", "height", "readOnly", "caption", "styles", "id", "registeredEventListeners", "resources", "hideOnMouseOut", "html", "primaryStyleName", "errorMessage", "enabled", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"enabled", "hideErrors", "required", "modified", "primaryStyleName", "errorMessage", "height", "readOnly", "styles", "propertyReadOnly", "description", "id", "width", "resources", "tabIndex", "registeredEventListeners", "caption", "immediate", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"description", "immediate", "classId", "embedParams", "width", "errorMessage", "archive", "styles", "height", "enabled", "codebase", "caption", "registeredEventListeners", "id", "resources", "readOnly", "standby", "alternateText", "primaryStyleName", "codetype", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"columns", "hideErrors", "enabled", "tabIndex", "width", "maxLength", "registeredEventListeners", "resources", "height", "inputPrompt", "wordwrap", "modified", "styles", "description", "immediate", "id", "required", "rows", "caption", "errorMessage", "primaryStyleName", "readOnly", "text", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.extension.javascriptmanager.JavaScriptManagerState.class, new String[] {"names", "enabled", "resources", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"primaryStyleName", "immediate", "altText", "readOnly", "errorMessage", "muted", "resources", "id", "autoplay", "registeredEventListeners", "styles", "width", "description", "showControls", "caption", "sources", "enabled", "height", "htmlContentAllowed", "sourceTypes", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"height", "styles", "primaryStyleName", "required", "description", "registeredEventListeners", "caption", "propertyReadOnly", "hideErrors", "immediate", "width", "modified", "errorMessage", "id", "readOnly", "resources", "enabled", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"readOnly", "sourceTypes", "immediate", "htmlContentAllowed", "id", "height", "resources", "styles", "width", "caption", "autoplay", "showControls", "muted", "enabled", "description", "errorMessage", "registeredEventListeners", "sources", "primaryStyleName", "altText", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"primaryStyleName", "immediate", "required", "width", "text", "styles", "id", "description", "inputPrompt", "modified", "resources", "errorMessage", "readOnly", "caption", "maxLength", "propertyReadOnly", "tabIndex", "height", "hideErrors", "enabled", "registeredEventListeners", "columns", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"immediate", "caption", "tabIndex", "resources", "primaryStyleName", "propertyReadOnly", "readOnly", "enabled", "height", "id", "hideErrors", "registeredEventListeners", "styles", "required", "errorMessage", "width", "modified", "checked", "description", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"styles", "readOnly", "description", "templateContents", "primaryStyleName", "caption", "templateName", "height", "immediate", "childLocations", "enabled", "resources", "width", "registeredEventListeners", "errorMessage", "id", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"enabled", "caption", "primaryStyleName", "description", "childCss", "styles", "registeredEventListeners", "width", "id", "errorMessage", "readOnly", "resources", "immediate", "height", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"styles", "primaryStyleName", "readOnly", "enabled", "height", "description", "id", "immediate", "errorMessage", "resources", "caption", "registeredEventListeners", "width", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"width", "styles", "immediate", "height", "splitterState", "readOnly", "description", "secondChild", "enabled", "firstChild", "caption", "registeredEventListeners", "resources", "errorMessage", "primaryStyleName", "id", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"readOnly", "resources", "immediate", "connectorToCssPosition", "errorMessage", "styles", "description", "enabled", "id", "height", "registeredEventListeners", "width", "primaryStyleName", "caption", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"resources", "id", "tabIndex", "registeredEventListeners", "required", "width", "hideErrors", "propertyReadOnly", "primaryStyleName", "styles", "height", "caption", "modified", "errorMessage", "enabled", "immediate", "description", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"description", "caption", "registeredEventListeners", "enabled", "width", "immediate", "resources", "alternateText", "readOnly", "height", "errorMessage", "styles", "id", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"readOnly", "width", "styles", "height", "registeredEventListeners", "primaryStyleName", "caption", "errorMessage", "immediate", "resources", "id", "enabled", "description", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"minPosition", "locked", "positionReversed", "maxPositionUnit", "maxPosition", "position", "positionUnit", "minPositionUnit", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"resources", "readOnly", "errorMessage", "enabled", "immediate", "description", "width", "id", "primaryStyleName", "styles", "registeredEventListeners", "alternateText", "height", "caption", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"resources", "immediate", "enabled", "errorMessage", "registeredEventListeners", "modified", "tabIndex", "caption", "readOnly", "textFieldEnabled", "width", "required", "primaryStyleName", "height", "propertyReadOnly", "description", "styles", "id", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"width", "enabled", "readOnly", "id", "tabIndex", "caption", "clickShortcutKeyCode", "styles", "registeredEventListeners", "disableOnClick", "errorMessage", "resources", "htmlContentAllowed", "description", "immediate", "height", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"readOnly", "id", "registeredEventListeners", "resources", "primaryStyleName", "spacing", "immediate", "enabled", "childData", "caption", "marginsBitmask", "width", "errorMessage", "styles", "height", "description", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"registeredEventListeners", "resources", "primaryStyleName", "id", "propertyReadOnly", "errorMessage", "modified", "tabIndex", "description", "enabled", "immediate", "height", "width", "readOnly", "required", "caption", "hideErrors", "styles", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"hideErrors", "width", "propertyReadOnly", "height", "registeredEventListeners", "styles", "errorMessage", "immediate", "required", "readOnly", "resources", "primaryStyleName", "tabIndex", "modified", "enabled", "description", "id", "caption", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"caption", "registeredEventListeners", "required", "immediate", "styles", "errorMessage", "modified", "id", "propertyReadOnly", "resources", "description", "primaryStyleName", "enabled", "height", "hideErrors", "tabIndex", "width", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"width", "parameters", "readOnly", "description", "errorMessage", "styles", "registeredEventListeners", "uriFragment", "immediate", "height", "id", "caption", "target", "features", "enabled", "primaryStyleName", "resources", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"immediate", "height", "primaryStyleName", "bgColor", "resources", "caption", "errorMessage", "description", "id", "cursorY", "styles", "enabled", "readOnly", "cursorX", "registeredEventListeners", "width", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"enabled", "styles", "color", "height", "id", "immediate", "primaryStyleName", "readOnly", "width", "htmlContentAllowed", "popupVisible", "resources", "showDefaultCaption", "description", "caption", "errorMessage", "registeredEventListeners", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"changedColor", "registeredEventListeners", "changedX", "height", "errorMessage", "primaryStyleName", "enabled", "immediate", "description", "changedY", "width", "readOnly", "caption", "styles", "id", "columnCount", "resources", "rowCount", });
